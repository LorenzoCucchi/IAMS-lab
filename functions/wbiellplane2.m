...
% PLANE CHANGE
[ DeltaV_plane , th_PC ,om_2] = change_plane (a_T2 , e_T2 ,i_i , OM_i , om_i , i_f , OM_f , mu);
...
[ DeltaV_periArg , th_peri_i , th_peri_f ] =Change_w (a_T2 , e_T2 , om_2 , om_3 , PI.theta);
...
%% change of plan,w,biell
    ...
    orb(3,7)=0;
    orb(3,8)=0;
    [ orb(2,8), orb(2,9), orb(2,10), orb(2,11), orb(2,1), orb(3,1), orb(2,2), orb(3,2)] = biellBitang (PI.a ,PI.e , PF.a , PF.e , r_aT , mu);
%     
% 
...
% %
    ...
    orb(4,4)=PF.OM;
    orb(4,3)=PF.i;
    [orb(4,8),orb(3,7),orb(4,5)] = change_plane(orb(3,1),orb(3,2),orb(3,3),orb(3,4),orb(3,5),orb(4,3),orb(4,4));
    orb(3,7)=orb(3,7)-pi;
    orb(4,6)=orb(3,7);
