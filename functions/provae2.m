...
%% change of e,plan,w,bitan
    ...
    orb(2,2)=0.5;
    %orb(2,2)=0.2
    [orb(2,8),orb(2,5) , orb(1,7), orb(2,1)] = ChangeOrbitShape (orb(1,1), orb(1,2), orb(1,3), orb(1,4), orb(1,5), PF.i , PF.OM , orb(2,2));
    orb(1,7)=orb(1,7)-pi; 
    orb(2,5)=pi+orb(2,5);
    orb(2,6)=0;
    ...
    orb(3,4)=PF.OM;
    orb(3,3)=PF.i;
    [orb(3,8),orb(2,7),orb(3,5)] = change_plane(orb(2,1),orb(2,2),orb(2,3),orb(2,4),orb(2,5),PF.i,PF.OM,398600.44);
    orb(3,6)=orb(2,7);
    ...
    orb(4,4)=orb(3,4);
    orb(4,5)=PF.om+pi;
    [orb(4,8), orb(3,7), orb(4,6)] = Change_w(orb(4,1), orb(4,2), orb(3,5), orb(4,5),orb(3,6));
